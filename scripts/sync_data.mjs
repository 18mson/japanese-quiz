...
const baseAdditionalWords = [
  ...
  { kanji: 'ここ', kana: 'ここ', romaji: ['koko'], meaning: 'sini, di sini', category: 'Kata Ganti', lesson: 'Pelajaran 3' },
  { kanji: 'そこ', kana: 'そこ', romaji: ['soko'], meaning: 'situ, di situ', category: 'Kata Ganti', lesson: 'Pelajaran 3' },
  { kanji: 'あそこ', kana: 'あそこ', romaji: ['asoko'], meaning: 'sana, di sana', category: 'Kata Ganti', lesson: 'Pelajaran 3' },
  { kanji: 'どこ', kana: 'どこ', romaji: ['doko'], meaning: '(di) mana', category: 'Kata Tanya', lesson: 'Pelajaran 3' },
  { kanji: 'こちら', kana: 'こちら', romaji: ['kochira'], meaning: 'sini, sebelah sini (sopan)', category: 'Kata Ganti', lesson: 'Pelajaran 3' },
  { kanji: 'そちら', kana: 'そちら', romaji: ['sochira'], meaning: 'situ, sebelah situ (sopan)', category: 'Kata Ganti', lesson: 'Pelajaran 3' },
  { kanji: 'あちら', kana: 'あちら', romaji: ['achira'], meaning: 'sana, sebelah sana (sopan)', category: 'Kata Ganti', lesson: 'Pelajaran 3' },
  { kanji: 'どちら', kana: 'どちら', romaji: ['dochira'], meaning: 'mana, sebelah mana (sopan)', category: 'Kata Tanya', lesson: 'Pelajaran 3' },
  { kanji: 'トイレ', kana: 'トイレ', romaji: ['toire'], meaning: 'toilet, kamar kecil', category: 'Kata Benda', lesson: 'Pelajaran 3' },
  { kanji: 'お手洗い', kana: 'おてあらい', romaji: ['otearai'], meaning: 'kamar kecil, toilet (sopan)', category: 'Kata Benda', lesson: 'Pelajaran 3' },
  { kanji: 'お国', kana: 'おくに', romaji: ['okuni'], meaning: 'negara, negeri', category: 'Kata Benda', lesson: 'Pelajaran 3' },
  { kanji: 'ワイン', kana: 'ワイン', romaji: ['wain'], meaning: 'anggur, minuman wine', category: 'Kata Benda', lesson: 'Pelajaran 3' },
  { kanji: 'ロビー', kana: 'ロビー', romaji: ['robii', 'robi'], meaning: 'ruang tunggu, lobi', category: 'Kata Benda', lesson: 'Pelajaran 3' },
  { kanji: 'エレベーター', kana: 'エレベーター', romaji: ['erebeetaa', 'erebeta'], meaning: 'lift, elevator', category: 'Kata Benda', lesson: 'Pelajaran 3' },
  { kanji: 'エスカレーター', kana: 'エスカレーター', romaji: ['esukareetaa', 'esukareta'], meaning: 'eskalator, tangga berjalan', category: 'Kata Benda', lesson: 'Pelajaran 3' },
  { kanji: 'うち', kana: 'うち', romaji: ['uchi', 'uti'], meaning: 'rumah', category: 'Kata Benda', lesson: 'Pelajaran 3' },
  { kanji: 'ネクタイ', kana: 'ネクタイ', romaji: ['nekutai'], meaning: 'dasi', category: 'Kata Benda', lesson: 'Pelajaran 3' },
  { kanji: 'いくら', kana: 'いくら', romaji: ['ikura'], meaning: 'berapa (harga)', category: 'Kata Tanya', lesson: 'Pelajaran 3' },
  { kanji: '～階', kana: '～かい', romaji: ['kai', 'gai', '~kai', '~gai', '-kai', '-gai'], meaning: 'lantai ~, tingkat ~', category: 'Kata Bantu Bilangan', lesson: 'Pelajaran 3' },
  { kanji: '何階', kana: 'なんがい', romaji: ['nangai'], meaning: 'lantai berapa, tingkat berapa', category: 'Kata Tanya', lesson: 'Pelajaran 3' },
  { kanji: '～円', kana: '～えん', romaji: ['en', '~en', '-en'], meaning: '~ yen', category: 'Akhiran', lesson: 'Pelajaran 3' },
  { kanji: '月曜日', kana: 'げつようび', romaji: ['getsuyoubi', 'getsuyobi'], meaning: 'hari Senin', category: 'Kata Benda', lesson: 'Pelajaran 4' },
  { kanji: '火曜日', kana: 'かようび', romaji: ['kayoubi', 'kayobi'], meaning: 'hari Selasa', category: 'Kata Benda', lesson: 'Pelajaran 4' },
  { kanji: '水曜日', kana: 'すいようび', romaji: ['suiyoubi', 'suiyobi'], meaning: 'hari Rabu', category: 'Kata Benda', lesson: 'Pelajaran 4' },
  { kanji: '木曜日', kana: 'もくようび', romaji: ['mokuyoubi', 'mokuyobi'], meaning: 'hari Kamis', category: 'Kata Benda', lesson: 'Pelajaran 4' },
  { kanji: '金曜日', kana: 'きんようび', romaji: ['kinyoubi', 'kinyobi'], meaning: 'hari Jumat', category: 'Kata Benda', lesson: 'Pelajaran 4' },
  { kanji: '土曜日', kana: 'どようび', romaji: ['doyoubi', 'doyobi'], meaning: 'hari Sabtu', category: 'Kata Benda', lesson: 'Pelajaran 4' },
  { kanji: '日曜日', kana: 'にちようび', romaji: ['nichiyoubi', 'nichiyobi', 'nitiyoubi'], meaning: 'hari Minggu', category: 'Kata Benda', lesson: 'Pelajaran 4' },
  { kanji: '何曜日', kana: 'なんようび', romaji: ['nanyoubi', 'nanyobi'], meaning: 'hari apa', category: 'Kata Tanya', lesson: 'Pelajaran 4' },
  { kanji: 'デパート', kana: 'デパート', romaji: ['depa-to', 'depato'], meaning: 'toserba, department store', category: 'Kata Benda', lesson: 'Pelajaran 4' },
