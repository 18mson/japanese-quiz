...
<template>
  ...
  >
    ...
    >
      <!-- Header -->
      <div class="p-6 text-center border-b border-gray-100 bg-amber-50/50">
        <div class="w-12 h-12 bg-amber-100 text-amber-600 rounded-full flex items-center justify-center mx-auto mb-3 border border-amber-200">
      ...
      <div class="p-6 space-y-4">
        <div class="bg-gray-50 p-4 rounded-xl border border-gray-200 space-y-3">
          <div class="flex items-center justify-between text-xs font-semibold text-gray-600">
            ...
            <span class="px-2 py-0.5 bg-indigo-100 text-indigo-700 rounded-full font-bold">
              {{ localCount }} Item
            </span>
          </div>
          ...
          <div class="flex items-center justify-between text-xs font-semibold text-gray-600">
            <div class="flex items-center gap-2">
              <CloudDownload class="w-4 h-4 text-emerald-500" />
              <span>Data Server (Akun Online)</span>
            </div>
            <span class="px-2 py-0.5 bg-emerald-100 text-emerald-700 rounded-full font-bold">
              {{ serverCount }} Item
            </span>
          </div>
        </div>
        ...
        <div class="grid grid-cols-2 gap-3 pt-2">
          <button 
            ...
            :disabled="loading"
            class="py-3 px-3 bg-gray-100 hover:bg-gray-200 text-gray-700 font-bold rounded-xl text-xs transition border border-gray-200 flex flex-col items-center justify-center gap-1 cursor-pointer disabled:opacity-50"
          >
            <span>Tidak</span>
            <span class="text-[10px] font-normal text-gray-500">Timpa Server dgn Lokal</span>
          </button>
